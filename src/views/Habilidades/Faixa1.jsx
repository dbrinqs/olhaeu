...
class Faixa1 extends React.Component {
  constructor(props) {
    super(props);
  ...
  /* ---- FUNCTION ---- */
  componentWillMount () {
    axios.post(BASE_URL + "indicadores.php?event=readByFaixa&faixa=0-18 meses")
    .then((response) => {
...
export default withStyles(styles)(Faixa1);
