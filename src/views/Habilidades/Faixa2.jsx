...
class Faixa2 extends React.Component {
  constructor(props) {
    super(props);
  ...
  /* ---- FUNCTION ---- */
  componentWillMount () {
    axios.post(BASE_URL + "indicadores.php?event=readByFaixa&faixa=19-47 meses")
    .then((response) => {
...
export default withStyles(styles)(Faixa2);
