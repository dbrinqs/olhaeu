...
var mensagens = [
  "Novo feriado municipal declarado no dia 23/07.",
  "MEC aprova nova medida.",
  "Reunião dos pais será adiada.",
  "Novo recurso no Olha Eu."
];

var tarefas = [
  "Comprar material para a atividade de hoje.",
  "Corrigir as provas dos alunos.",
  "Checar o cardápio da semana."  
];
...
class Agenda extends React.Component {
  ...
  constructor(props){
    ...
    this.state = {
      ...
      open:false, openAtiv: false, openTime: false, openIndic: false, openTEnd:false, messages:mensagens, tasks:tarefas    
    }
  ...
  removeMensagem = (index) => {
    console.log("removeMensagem " + index);
    var msgs = this.state.messages.slice(0);
    msgs.splice(index, 1);
    this.setState({messages:msgs});
  }

  removeTarefas = (index) => {
    console.log("removeTarefas " + index);
    var tarf = this.state.tasks.slice(0);
    tarf.splice(index, 1);
    this.setState({tasks:tarf});
  }
  ...
  return (
          ...
          tabs={[
            {
              ...
              tabContent: (
                <Tasks
                  checkedIndexes={[]}
                  tasks={this.state.messages}
                  remove={this.removeMensagem}
                />
              )
            },
            {
    ...
    <Card>
      <CardHeader color="primary">
        <h4 className={style.cardTitleWhite}>Minha agenda</h4>
...
export default withStyles(style)(Agenda);
